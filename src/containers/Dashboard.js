...
export default class {
    ...
    handleShowTickets(e, bills, index) {
        ...
        if (this.counter % 2 === 0) {
            ...
            //Déclaration d'une variable pour contenir les tickets
            let selectedBills = filteredBills(bills, getStatus(this.index))
            $(`#status-bills-container${this.index}`).html(cards(selectedBills))
            //On ajoute un ecouteur aux bills sélectionnés dans drop down concerné
